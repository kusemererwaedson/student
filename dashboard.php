...
<div class="main" style="margin-left: 15%;">
  ...
  <div class="row mt-3">
                <div class="col-lg-6">
                <h5><span class='text-info'>Welcome</span>&nbsp;"<span class='text-warning'><?= $row['first_name']; ?>&nbsp;<?= $row['last_name'];?></span>"</h5>
                </div>
                <div class="col-lg-6">
                </div>
        </div>        
      ...
      <div class="modal-dialog">
        <div class="modal-content">
          ...
          <div class="modal-body">
            <form action="studentbackend/editpass.php" class="form-horizontal" method="POST" enctype="multipart/form-data">
