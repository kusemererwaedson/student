   ...
   <?php include('includes/sidebar.php') ?>
    ...
    <div class="main" style="margin-left: 15%;">
      <div class="container">
        <div class="row mt-3">
                <div class="col-lg-6">
                    <h3 class="text-info">Student Registration Track Record</h3>
                </div>
                <div class="col-lg-6">
                </div>
        </div>
            ...
            <table class="table table-bordered table-striped">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <?php if($student['reg_status'] == "registered"){ ?>
                  <td class="text-success"><?= $student['reg_status'] ?></td>
                  <?php } ?>
                  <?php if($student['reg_status'] == "pending"){ ?>
                  <td class="text-warning"><?= $student['reg_status'] ?></td>
                  <?php } ?>
                  <td><?= $student['year'] ?></td>
                  <td><?= $student['sem'] ?></td>
